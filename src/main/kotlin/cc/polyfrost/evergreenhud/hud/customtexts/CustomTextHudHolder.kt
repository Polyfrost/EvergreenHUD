...
val MINUS_ICON = SVG("/assets/evergreenhud/minus.svg")
const val WHITE_90 = 0xE5FFFFFF.toInt()

@Suppress("UnstableAPIUsage")
class CustomTextHudHolder(
    private val config: CustomTexts,
    @field:HUD(name = "Options") val hud: CustomTextHud
) {
