...
class ImagesOptionList(private val config: CustomImages) : BasicOption(null, null, "", "", "General", "", 2) {
    ...
    init {
        addButton.setClickAction {
            config.hudHolders.add(CustomImageHudHolder(config, CustomImageHud()))
        }
    }
